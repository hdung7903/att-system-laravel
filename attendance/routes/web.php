...
Route::prefix('admin')->group(function () {
    ...
    Route::post('/import', [App\Http\Controllers\AdminController::class, 'importUserListData'])->name('admin.import');
...
Route::prefix('student')->group(function () {
    ...
    Route::get('/schedule', [App\Http\Controllers\StudentController::class, 'schedule']);
});
